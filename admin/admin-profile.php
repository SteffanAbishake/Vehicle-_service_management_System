...
if (strlen($_SESSION['adid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "update tbladmin set AdminName='$AName',Email='$EMail',MobileNumber='$MNum' where ID='$adminid'");
        if ($query) {
                                                    ...
                                                    <form class="form-horizontal" role="form" method="post" >
                                                        ...
                                                        while ($row = mysqli_fetch_array($ret)) {
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-10">
                                                                    <input type="email" class="form-control" name="email" id="email" required="true"  value="<?php echo $row['Email']; ?>">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
