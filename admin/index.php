...
if (isset($_POST['login'])) {
    ...
    $query = mysqli_query($con, "select * from tbladmin where  AdminuserName='$adminuser' && Password='$password' ");
    ...
    }else if($ret['status'] == "Disabled"){
        $msg = "You're Disabled by Admin";
...
<html lang="en">
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('images/Carwash2.jpg');background-size: cover;background-position: center;"></div>
...
?> </p>
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright"> <small>2020 © Vehicle Service Managment System From SDR Software Solution</small></p>
            </div>
