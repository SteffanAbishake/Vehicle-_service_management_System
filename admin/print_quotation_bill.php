                                                ...
                                                <div class="p-20">
                                                        ...
                                                        <div class="col">
                                                            <div class="row">
                                                                <div class="col">
                                                                    ...
                                                                    <h5 class="text-right">Bill Generated By: <?php echo $admname; ?></a> </h5>
                                                    ...
                                                    while ($row = mysqli_fetch_array($ret)) {
                                                        ...
                                                        <table  class="table table-sm">
                                                            ...
                                                            <tr>
                                                                <th>Parts Total</th>
                                                                <td class="text-right"><?php $pchrg = $row['PartsCharge'];
                                                    echo "LKR: " . $pchrg . "/="; ?></td>
                                                            </tr>
                                                            <?php
                                                            $indx = 1;
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right"><?php $schrg = $row['ServiceCharge'];
                                                            echo "LKR: " . $schrg . "/="; ?></td>
                                                            </tr>
                                                            <tr class="d-none">
                                                                <th>Admin Remark</th>
                                                            ...
                                                            <tr>
                                                                <th>Total Amount</th>
                                                                <td class="text-right"><?php $totally = $schrg + $pchrg;
                                                            echo "LKR: " . $totally . "/="; ?></td>
                                                            </tr>

<?php
                                                            $pd = mysqli_query($con, "Select * from payment_details_quota pd where pd.tblservicerequest_quotation_ID= '$cid'");
