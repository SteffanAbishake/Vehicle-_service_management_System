                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="row" id="reportforrow">
                                            ...
                                            <div class="col-6" id="selmonth">
                                                ...
                                                $thy = date("Y");
                                                $y_m = $thy . "-" . $thm;
                                                $da = mysqli_query($con, "select * from tblservicerequest ts where ts.ServiceDate like '$thy%' ORDER BY ts.ServiceDate ASC");
                                                $da1 = mysqli_query($con, "select * from tblservicerequest_quotation ts where ts.ServiceDate like '$thy%' ORDER BY ts.ServiceDate ASC");
                                                $da2 = mysqli_query($con, "select * from tblservicerequest ts  ORDER BY ts.ServiceDate ASC");
                                                $da3 = mysqli_query($con, "select * from tblservicerequest_quotation ts  ORDER BY ts.ServiceDate ASC");
                                                $mon_arr = array();
                                                $y_arr = array();
                                                while ($mon = mysqli_fetch_array($da)) {
                                                    array_push($mon_arr, explode("-", $mon['ServiceDate'])[1]);
                                                }
                                                ...
                                                <select id="month" onchange="chang();">
                                                    <?php
                                                    foreach (array_unique($mon_arr) as $key => $value) {
                                                        if ($value == $thm) {
                                                            ?>
        ...
        <script type="text/javascript" >
                                                    ...
                                                    function reportfor() {
                                                        ...
                                                        if (reportfor == "Daily") {
                                                            ...
                                                            req.open("GET", "backgroundworks/dateload_salesreport.php?repfor=" + reportfor + "&month=" + smonth + "&year=" + syear, true);
                                                            req.send();
                                                            ...
                                                            req.open("GET", "backgroundworks/dateload_salesreport.php?repfor=" + reportfor + "&year=" + syear, true);
                                                            req.send();
                                                        ...
                                                        if (hidee.value == "hidden") {
                                                            ...
                                                            req.onreadystatechange = function () {
                                                                if (req.status === 200 && req.readyState === 4) {
                                                                    ...
                                                                    table_head_row.appendChild(table_head_title_No);
                                                                    var table_head_title_Product = document.createElement("th");
                                                                    table_head_title_Product.innerHTML = "Bill No";
                                                                    table_head_row.appendChild(table_head_title_Product);
                                                                    var table_head_title_OpeningStockQty = document.createElement("th");
                                                                    table_head_title_OpeningStockQty.innerHTML = "Service Charge";
                                                                    table_head_row.appendChild(table_head_title_OpeningStockQty);
                                                                    var table_head_title_PurchasedQty = document.createElement("th");
                                                                    table_head_title_PurchasedQty.innerHTML = "Parts Sold";
                                                                    table_head_row.appendChild(table_head_title_PurchasedQty);
                                                                    ...
                                                                    for (var i = 0; i < o.length; i++) {
                                                                        ...
                                                                        //                                                            tablebody
                                                                        var tbody_tr = document.createElement("tr");
                                                                        tbody_tr.setAttribute("onclick","viewbill('"+o[i].link+"')")
                                                                        tbody.appendChild(tbody_tr);
                                                                        var tbody_td_no = document.createElement("td");
                                                                        tbody_tr.appendChild(tbody_td_no);
                                                                        ...
                                                                        var tbody_td_product = document.createElement("td");
                                                                        tbody_tr.appendChild(tbody_td_product);
                                                                        tbody_td_product.innerHTML = o[i].bill;
                                                                        var tbody_td_osq = document.createElement("td");
                                                                        tbody_tr.appendChild(tbody_td_osq);
                                                                        tbody_td_osq.innerHTML = o[i].SC;
                                                                        var tbody_td_pq = document.createElement("td");
                                                                        tbody_tr.appendChild(tbody_td_pq);
                                                                        tbody_td_pq.innerHTML = o[i].PC;
                                                                        tpc = o[i].total_PC;
                                                                        tsc = o[i].total_SC;
                                                                    ...
                                                                    var tfooter_row_td_total_val = document.createElement("td");
                                                                    tfooter_row_td_total_val.innerHTML = tsc;
                                                                    tfooter_row.appendChild(tfooter_row_td_total_val);
                                                            ...
                                                            req.open("GET", "backgroundworks/sales_report_data.php?date=" + x, true);
                                                            req.send();
                                                        } else {
                                                            hidee.value = "hidden";
                                                            tablemain.innerHTML = "";
                                                    ...
                                                    function yrchang() {
                                                        ...
                                                        req.open("GET", "backgroundworks/sales_report_yr_change.php?repfor=" + reportfor + "&year=" + m, true);
                                                        req.send();
                                                    }
