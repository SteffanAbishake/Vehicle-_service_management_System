...
if (strlen($_SESSION['adid'] == 0)) {
    ...
    ?>
                                            ...
                                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                                <div class="card-box mb-0 widget-chart-two">
                                                    <div class="float-right">
    <?php
    $query1 = mysqli_query($con, "Select * from tblservicerequest_quotation");
    ...
    ?>
                                                    ...
                                                    <div class="widget-chart-two-content">
                                                        <p class="text-muted mb-0 mt-2">Total Quotation</p>
                                            ...
                                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                                <div class="card-box mb-0 widget-chart-two">
                                                    <div class="float-right">
    <?php
    $query2 = mysqli_query($con, "Select * from tblmechanics");
    ...
    ?>
                                            ...
                                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                                <div class="card-box mb-0 widget-chart-two">
                                                    <div class="float-right">
                                                        <?php
                                                        $query3 = mysqli_query($con, "Select * from tblservicerequest");
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                                <div class="card-box mb-0 widget-chart-two">
                                                    <div class="float-right">
                                                        <?php
                                                        $query31 = mysqli_query($con, "Select * from tblservicerequest where AdminStatus='1'");
                                                    ...
                                                    <div class="widget-chart-two-content">
                                                        <p class="text-muted mb-0 mt-2">Pending Services</p>
                                            ...
                                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                                <div class="card-box mb-0 widget-chart-two">
                                                    <div class="float-right">
                                                        <?php
                                                        $query32 = mysqli_query($con, "Select * from tblservicerequest where AdminStatus='2'");
                                            ...
                                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                                <div class="card-box mb-0 widget-chart-two">
                                                    <div class="float-right">
                                                        <?php
                                                        $query33 = mysqli_query($con, "Select * from tblservicerequest where AdminStatus='3'");
                                            ...
                                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                                <div class="card-box mb-0 widget-chart-two">
                                                    <div class="float-right">
                                                        <?php
                                                        $query4 = mysqli_query($con, "Select * from stock");
                                                        $stockcount = mysqli_num_rows($query4);
                                                        ?>
                                                        <input data-plugin="knob" data-width="80" data-height="80" data-linecap=round
                                                               data-fgColor="#8e44ad" value="<?php echo $stockcount; ?>" data-skin="tron" data-angleOffset="180"
                                                               data-readOnly=true data-thickness=".2"/>
                                                    </div>
                                                    <div class="widget-chart-two-content">
