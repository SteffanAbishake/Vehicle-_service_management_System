...
<!--                  <th>Email</th>-->
               ...
               <?php
$ret=mysqli_query($con,"select tblservicerequest.ServiceNumber,tblservicerequest.Category,tblservicerequest.ID as apid, tbluser.FullName,tbluser.MobileNo,tbluser.Email,tbluser.RegDate,tblservicerequest.VehicleRegno  from  tblservicerequest inner join tbluser on tbluser.ID=tblservicerequest.UserId where tblservicerequest.AdminStatus='1'");
$cnt=1;
